    ...
    return (
        <div>
            <label className={props.disabled ? "reserve-card_disabled" : "reserve-card"}>
                ...
                <span className={props.disabled ? "reserve-card__checkbox__disabled" : "reserve-card__checkbox"}/>
                <span>{props.startTime.format('HH:mm')} - {props.endTime.format('HH:mm')}</span>
            </label>
            <style jsx>{`
                .reserve-card {
                    @apply text-lg text-gray-600 flex flex-row px-2 py-3 border-gray-600 border rounded self-center items-center my-2;
                ...
                .reserve-card input:checked ~ .reserve-card__checkbox{
                  @apply bg-secondary;
                }
                .reserve-card_disabled {
                   @apply text-lg text-gray-400 flex flex-row px-2 py-3 border-gray-400 border rounded self-center items-center my-2;
                }
                .reserve-card:hover{
